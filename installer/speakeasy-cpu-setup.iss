...
;
; Produces a single versioned SpeakEasy-AI-Granite-CPU-Setup executable that handles:
...
LicenseFile=..\LICENSE
OutputDir=Output
OutputBaseFilename=SpeakEasy-AI-Granite-CPU-Setup-{#MyAppVersion}
#ifdef FastCompress
...
begin
  ...
  Info := Info + Space + 'IBM Granite Speech 4.1 2B  (CPU mode, ASR and translation)' + NewLine + NewLine;
...
begin
  ...
  begin
    Json := '{' + #13#10 + '  "engine": "granite",' + #13#10 + '  "device": "cpu",' + #13#10 + '  "hotkeys_enabled": true' + #13#10 + '}';
