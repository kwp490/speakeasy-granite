...
The current public test build is available from the [v0.14.3 GitHub release](https://github.com/kwp490/speakeasy-granite/releases/tag/v0.14.3).

| Installer | Best for | Download | Size |
| --- | --- | --- | ---: |
| GPU+CPU installer | Windows 10/11 systems with an NVIDIA GPU and >= 8GB VRAM for fast, local transcription. | [SpeakEasy-AI-Granite-Setup-0.14.3.exe](https://github.com/kwp490/speakeasy-granite/releases/download/v0.14.3/SpeakEasy-AI-Granite-Setup-0.14.3.exe) | 1.87 GB |
| CPU installer | Windows 10/11 systems without NVIDIA CUDA support; slower but does not require a dedicated NVIDIA GPU. | [SpeakEasy-AI-Granite-CPU-Setup-0.14.3.exe](https://github.com/kwp490/speakeasy-granite/releases/download/v0.14.3/SpeakEasy-AI-Granite-CPU-Setup-0.14.3.exe) | 202 MB |
